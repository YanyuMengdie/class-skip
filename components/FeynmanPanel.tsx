...
import { generateFeynmanExplanation } from '../services/geminiService';
...
export const FeynmanPanel: React.FC<FeynmanPanelProps> = ({ onClose, pdfContent }) => {
        ...
        <div className="flex-1 overflow-y-auto p-6 prose prose-sm max-w-none">
          {loading && (
            <div className="flex flex-col items-center justify-center py-16 text-sky-500">
              ...
              <p className="text-sm font-bold">正在用大白话重讲这份内容...</p>
            </div>
          )}
          {error && !loading && (
